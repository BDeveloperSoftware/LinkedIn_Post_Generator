...
class PostGenerator:
    ...
    def generate_post_text(self, article_prompt):
        model = "gpt-4-turbo" if self.model_provider == "gpt4" else "llama3-70b-8192"
        full_prompt = f"""
